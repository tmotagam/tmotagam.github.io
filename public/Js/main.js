...
function startApp(app) {
    if (app == null || app == '' || app == " ") {
        ...
        if (app == 'sms') {
            ...
            return document.getElementById("route").innerHTML = `<zero-md src="../markdown/sms.md"></zero-md>`;
        } else if (app == 'tfx') {
            document.getElementById("app").innerHTML = `<img src="/public/images/tahafacex.webp" width="100" height="100" alt="">`;
            return document.getElementById("route").innerHTML = `<zero-md src="../markdown/tfx.md"></zero-md>`;
        } else if (app == 'ftpt') {
            document.getElementById("app").innerHTML = `<img src="/public/images/ftpt.webp" width="100" height="100" alt="">`;
            return document.getElementById("route").innerHTML = `<zero-md src="../markdown/ftpt.md"></zero-md>`;
        } else if (app == 'ope') {
            document.getElementById("app").innerHTML = `<img src="/public/images/ope.webp" width="100" height="100" alt="">`;
            return document.getElementById("route").innerHTML = `<zero-md src="../markdown/ope.md"></zero-md>`;
        }
    }

    if (app == 'sms_docs') {
        document.getElementById("app").innerHTML = `<img src="/public/images/StoreManagementSystemIcon.webp" width="100" height="100" alt="">`;
        return document.getElementById("route").innerHTML = `<zero-md src="../markdown/sms_docs.md"></zero-md>`;
    } else if (app == 'tfx_docs') {
        document.getElementById("app").innerHTML = `<img src="/public/images/tahafacex.webp" width="100" height="100" alt="">`;
        return document.getElementById("route").innerHTML = `<zero-md src="../markdown/tfx_docs.md"></zero-md>`;
    } else {
        document.getElementById("app").innerHTML = `<img src="/public/images/oops.webp" width="200" height="150" alt="">`;
        return document.getElementById("route").innerHTML = `<p class="h5">Something is not right about this page. <a href="../projects/" class="text-decoration-none">click here</a></p>`;
    }
}